...
def learn():
    ...
    return "I have already done a bit of python so a lot of this was review for me however, I learned that I need to work on the logic of manipulating data as that is my weak point. I appreciate this website creating lession, I will try to take it further with a project."
